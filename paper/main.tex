...
% Blue section headers to match reference format
\definecolor{sectionblue}{RGB}{47,85,151}
\titleformat{\section}{\Large\bfseries\color{sectionblue}}{\thesection.~}{0em}{}
\titleformat{\subsection}{\large\bfseries\color{sectionblue}}{\thesubsection~}{0em}{}
\titleformat{\subsubsection}{\normalsize\bfseries\color{sectionblue}}{\thesubsubsection~}{0em}{}
...
% Title block matching reference format
\begin{center}
{\LARGE\bfseries Compound Weather Event Interaction Modeling with Calibrated Uncertainty for State-Agnostic Power Outage Prediction\par}
\vspace{12pt}
Vijaya Sivanjan Kommuri, Tejaswi Mahadev, Rhea Chase\\[4pt]
\textit{Department of Artificial Intelligence and Machine Learning, Malla Reddy University, India}\\[2pt]
{\small vjkommuri@gmail.com $|$ rheachrischase@gmail.com}\\[8pt]
\textit{Under the guidance of}\\[2pt]
\textbf{Dr.\ Md.\ Adam Baba, Ph.D.}\\
{\small drmohammad.adambaba@mallareddyuniversity.ac.in}
\end{center}
...
\vspace{8pt}
\section*{{\color{sectionblue}Abstract}}
...
\textbf{Keywords:} Power outage prediction, compound weather events, uncertainty quantification, ensemble learning, XGBoost, spatial indexing, H3
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/fig1_reliability_diagram.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/fig_shap_bar.pdf}
